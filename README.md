...
当前版本 **v1.1.1-pre.1**（Alpha 测试期 · 预发布）· Windows 安装包见 [GitHub Releases](https://github.com/Asheep233/knowledge-editor/releases)

本项目开发过程包含 AI Agent 协作，透明性声明见 [docs/agent-collaboration.md](docs/agent-collaboration.md)。

## 安装（Windows 桌面版）

1. 从 [Releases](https://github.com/Asheep233/knowledge-editor/releases) 下载 `KnowledgeEditor_1.1.0_x64-setup.exe`（最新正式安装包；1.1.1-pre.1 为代码级预发布，安装包随 1.1.1 正式版产出）。
